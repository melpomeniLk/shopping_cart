...
## Project Overview
This project supports the main goal, allowing users to browse, add, edit, and add products to the cart. However, please note that local storage functionality for storing product data is not currently supported.

## Structure
The project is structured into four main components:

1. **Products List:** This component displays the available products for users to browse.

2. **Cart:** Users can view their selected products in the cart component along with the total price. If a product becomes unavailable, it is automatically removed from the cart.

3. **Add New Product Form:** Administrators can use this component to add new products to the store.
